...
void videogame::mostrar()
{
    cout << left ;
    cout <<setw(15)<<"Nombre";
    cout <<setw(22)<<"ubicacion en x";
    cout <<setw(22)<<"ubicacion en y";
...
void videogame::respaldar()
{
    ...
    if(archivo.is_open()){
        for(size_t i=0;i<civilizaciones.size(); i ++){
                ...
                archivo <<p.getUbicacion_x()<<endl;
                archivo <<p.getUbicacion_y()<<endl;
...
void videogame::recuperar()
{
    ...
    if(archivo.is_open()){
        ...
        while (true)
        {
            ...
            p.setUbicacion_x(ubicacion_x);

            getline(archivo, temp);
            ubicacion_y = stoi(temp);
            p.setUbicacion_y(ubicacion_y);
...
void videogame::ordenarUbicacion_x()
{
    ...
    {return p1.getUbicacion_x()> p2.getUbicacion_x();});
}
void videogame::ordenarUbicacion_y()
{
    sort(civilizaciones.begin(),civilizaciones.end(),[]( Civilizacion p1, Civilizacion p2)
    {return p1.getUbicacion_y()> p2.getUbicacion_y();});
}
